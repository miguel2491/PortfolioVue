<link src="../../public/css/timeline.css" />
<template>
    ...
    <div id="primary" class="content-area">
        ...
        <div class="row">
            ...
            <div id="portfolio_content_q" class="portfolio-content">
                ...
                <li>
                    <a class="filter btn btn-sm btn-link" data-group="category_detailed">MicroTec</a>
                </li>
                
                <li>
                    <a class="filter btn btn-sm btn-link" data-group="category_direct-url">DCubica</a>
                </li>
                
                <li>
                    <a class="filter btn btn-sm btn-link" data-group="category_image">Profeti Consultores</a>
                </li>
                
                <li>
                    <a class="filter btn btn-sm btn-link" data-group="category_soundcloud">NERU</a>
                </li>

                <li>
                    <a class="filter btn btn-sm btn-link" data-group="category_video">Financiera Sumate</a>
                </li>
                
                <li>
                    <a class="filter btn btn-sm btn-link" data-group="category_vimeo-video">Grupo Enthous</a>
                </li>
                
                <li>
                    <a class="filter btn btn-sm btn-link" data-group="category_youtube-video">Castelán Auditores</a>
                </li>
                </ul>
